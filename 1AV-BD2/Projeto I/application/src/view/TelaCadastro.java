...
public class TelaCadastro extends JPanel {
	...
	public TelaCadastro(JFrame parentFrame) {
		...
		cadastrarButton.setBounds(264, 219, 98, 23);
		add(cadastrarButton);
		...
		voltarButton.setBounds(369, 219, 89, 23);
		add(voltarButton);

		JLabel nomeLabel = new JLabel("Nome:");
		nomeLabel.setBounds(293, 116, 39, 14);
		add(nomeLabel);
		
		JLabel foneLabel = new JLabel("Fone:");
		foneLabel.setBounds(293, 141, 39, 14);
		add(foneLabel);

		JLabel emailLabel = new JLabel("Email:");
		emailLabel.setBounds(293, 166, 39, 14);
		add(emailLabel);

		JLabel senhaLabel = new JLabel("Senha:");
		senhaLabel.setBounds(293, 191, 39, 14);
		add(senhaLabel);

		nameField = new JTextField();
		nameField.setBounds(342, 113, 86, 20);
		add(nameField);
		nameField.setColumns(10);
		
		foneField = new JTextField();
		foneField.setBounds(342, 138, 86, 20);
		add(foneField);
		foneField.setColumns(10);

		emailField = new JTextField();
		emailField.setBounds(342, 163, 86, 20);
		add(emailField);
		emailField.setColumns(10);

		senhaField = new JPasswordField();
		senhaField.setBounds(342, 188, 86, 20);
		add(senhaField);
