...
public class TelaPedido extends JPanel {
	...
	public TelaPedido(int id_cliente, JFrame parentFrame) {
		...
		dataLabel.setBounds(112, 87, 95, 14);
		add(dataLabel);
		
		JLabel valorLabel = new JLabel("Valor do pedido:");
		valorLabel.setBounds(112, 115, 95, 14);
		add(valorLabel);
		
		dataField = new JTextField();
		dataField.setBounds(210, 84, 86, 20);
		add(dataField);
		dataField.setColumns(10);
		
		valorField = new JTextField();
		valorField.setBounds(210, 112, 86, 20);
		add(valorField);
		...
		cadastrarPedidoButton.setBounds(135, 156, 153, 23);
